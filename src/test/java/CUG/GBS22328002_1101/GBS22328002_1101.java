...
static XSSFWorkbook workbook;
    ...
    static int ROW =1;
    static int COLUMN =2;
    static String XLSXpath = System.getProperty("user.dir")+"/src/test/java/CUG/GBS22328002_1101/CUGtestfile.xlsx";
