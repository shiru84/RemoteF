...
static XSSFWorkbook workbook;
    ...
    static int r =0;
    static int c =1;
    static String XLSXpath = System.getProperty("user.dir")+"/src/test/java/CUG/CUG2023_1586/CUGtestfile.xlsx";
    public WebElement copyHolder;
    public static String positionOne = "//*[@id=\"product\"]/div/div[2]/div[2]/ul/li/div/div[2]/div[2]/div[1]/div[1]";
...
void getFromExcell(String position) throws IOException {
    ...
    void writeResult (WebElement CopyHolder, Integer cValue) throws IOException {
    ...
    public static void takeScreenshot(Integer ROW) {
        ...
        File destFile = new File( System.getProperty("user.dir")+"/src/test/java/CUG/CUG2023_1586/Screenshots/" + ROW + ".jpg");
