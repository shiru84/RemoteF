...
static XSSFWorkbook workbook;
    ...
    static int r =0;
    static int c =1;
    static String XLSXpath = System.getProperty("user.dir")+"/src/test/java/CUG/D2SIBR_550/CUGtestfile.xlsx";
...
void getFromExcell(String position) throws IOException {
    ...
    public static void takeScreenshot(Integer ROW) {
        ...
        File destFile = new File( System.getProperty("user.dir")+"/src/test/java/CUG/D2SIBR_550/ScreenshotsPFMX3/" + ROW + ".jpg");
...
//        if(copyHolder.getText().contains(COPY)){
//            writeResult(copyHolder, 3);
//        } else {
//        getFromExcell(positionTwo);
//                if(copyHolder.getText().contains(COPY)){
//                writeResult(copyHolder, 4);
//                } else {
//                    takeScreenshot(r);
//            }
//
//        }
        ...
        if (actualSKU.getText().contains(SKU)) {
            ...
            try {
                driver.findElement(By.xpath("//*[@id=\"product\"]/div/div[2]/div[2]/ul/li/div/div[2]/div[2]/div[2]/a[2]")).isDisplayed();
                ...
                if (copyHolder.getText().contains(COPY)) {
                    ...
                    System.out.println(COPY);
                    takeScreenshot(r);
                    writeResult(copyHolder.getText(), 3);
                    writeResult("PASS", 4);
                    Assert.assertTrue(true, "text found in position 1");
                } else {
//                    getFromExcell(positionTwo);
//                    System.out.println(copyHolder.getText());
//                    System.out.println(COPY);
                    ...
                    Assert.assertTrue(false, "WRONG TEXT");
                }

            } catch (org.openqa.selenium.NoSuchElementException e) {
                writeResult("NOT FOR SALE", 4);
                System.out.println("NOT FOR SALE");
                Assert.assertTrue(false, "SKU NOT FOR SALE.");}
        }else {
            takeScreenshot(r);
            writeResult("SKU NOT FOUND", 4);
...
//            } catch (Error error) {
//                getFromExcell(positionTwo);
//                System.out.println("position two test try");
//                System.out.println(copyHolder.getText());
//                System.out.println(COPY);
//                writeResult(copyHolder.getText(), 4);
////                Assert.assertTrue(copyHolder.getText().contains(COPY));
//            } finally {
//                takeScreenshot(r);
//            }
